...
SEXPs are header thingies that describe objects. If you look at the [beastiary of SEXPs in the R language](https://cran.r-project.org/doc/manuals/r-release/R-ints.html#SEXPTYPEs) you will see there are no non-vector data type objects.  
